...
function build() {
  ...
  var labelsDir = join(contentsDir, '_labels-great.gov.uk');
  var structureDir = join(modulesDir, 'great.gov.uk-structure/structure');
  var layoutDir = join(modulesDir, 'great.gov.uk-layout');
